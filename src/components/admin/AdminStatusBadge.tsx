...
const variantStyles: Record<AdminStatusVariant, string> = {
  ...
  warning: 'bg-amber-100 dark:bg-amber-500/25 text-amber-800 dark:text-amber-300 border-amber-200 dark:border-amber-500/40',
  error: 'bg-red-100 dark:bg-red-500/25 text-red-800 dark:text-red-300 border-red-200 dark:border-red-500/40',
  info: 'bg-amber-50 dark:bg-amber-500/20 text-amber-800 dark:text-amber-300 border-amber-200 dark:border-amber-500/30',
